...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   if (!empty($_POST['medicine_name']) && !empty($_POST['quantity']) && !empty($_POST['mrp'])) {
       $bulk = new MongoDB\Driver\BulkWrite;
        $lowstockbulk = new MongoDB\Driver\BulkWrite;
    ...
    <div class="form-container" style="max-height: 80vh; padding: 30px;">
        ...
        <form action="edit_medicine.php" method="post">
            ...
            <div class="input-row">
                ...
                <input type="month" id="expiry_date" name="expiry_date" value="<?= $medicine->Expiry_Date ?>">
            ...
            <div class="input-row">
                ...
                <input type="number" id="discount" name="discount" value="<?= $medicine->discount ?>" required>
            </div>
